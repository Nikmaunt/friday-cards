        ...
        <div>
            ...
            >
                <MenuItem onClick={goToProfile}> <img src={profileUserLogo}
                                                      ...
                                                      alt="profileUserLogo"/>Profile</MenuItem>
                <MenuItem onClick={logOutHandler}> <img src={arrowIcon} style={{width: 20, height: 20, marginLeft: -6}}
                                                        alt="logoutIcon"/>Logout</MenuItem>
            </Menu>
        </div>
    );
};
