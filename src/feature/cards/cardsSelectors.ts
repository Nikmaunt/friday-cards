...
export const selectorCardsPage = (state: RootReducerType) => state.cards.page
export const selectorCardsRowsPerPage = (state: RootReducerType) => state.cards.pageCount
